    ...
    return (
        <div className="menu flex flex-col space-y-4">
            ...
            <ul className="space-y-3 text-sm ">
                <li className="text-gray-600  hover:text-gray-800 cursor-pointer transition-colors">Overview</li>
                <li className="text-gray-600 hover:text-gray-800 cursor-pointer transition-colors">Projects</li>
            </ul>
            <div className="flex flex-col space-y-2 text-sm">
                <p className="px-3 text-[#A4a4a4]">Dashboards</p>
                <Toggle className="!mx-0">
